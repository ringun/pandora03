...
$(document).ready(function(){function e(){var o="July 31,2015 23:59",t=new Date(o),r=new Date,i=t-r;if(t>r){var c=parseInt(i/864e5);10>c&&(c="0"+c),c=c.toString();var s=parseInt(i/36e5)%24;10>s&&(s="0"+s),s=s.toString();var a=parseInt(i/6e4)%60;10>a&&(a="0"+a),a=a.toString();var l=parseInt(i/1e3)%60;10>l&&(l="0"+l),l=l.toString(),9==c[1]&&2==s[0]&&3==s[1]&&5==a[0]&&9==a[1]&&5==l[0]&&9==l[1]?n($("#day0"),c[0]):$("#day0").html(c[0]),2==s[0]&&3==s[1]&&5==a[0]&&9==a[1]&&5==l[0]&&9==l[1]?n($("#day1"),c[1]):$("#day1").html(c[1]),3==s[1]&&5==a[0]&&9==a[1]&&5==l[0]&&9==l[1]?n($("#hour0"),s[0]):$("#hour0").html(s[0]),5==a[0]&&9==a[1]&&5==l[0]&&9==l[1]?n($("#hour1"),s[1]):$("#hour1").html(s[1]),9==a[1]&&5==l[0]&&9==l[1]?n($("#min0"),a[0]):$("#min0").html(a[0]),5==l[0]&&9==l[1]?n($("#min1"),a[1]):$("#min1").html(a[1]),9==l[1]?n($("#sec0"),l[0]):$("#sec0").html(l[0]),n($("#sec1"),l[1]),setTimeout(e,1e3)}else $(".timer").html("<p id='stop'>Отсчет закончен!!!</p>")}function n(e,n){e.html(n).css({marginTop:"0px"}).animate({marginTop:"0px"})}e(),blocScroll=function(){document.onmousewheel=document.onwheel=function(){return!1},document.addEventListener("MozMousePixelScroll",function(){return!1},!1),document.onkeydown=function(e){return e.keyCode>=33&&e.keyCode<=40?!1:void 0}},unblocScroll=function(){document.onmousewheel=document.onwheel=function(){return!0},document.addEventListener("MozMousePixelScroll",function(){return!1},!0),document.onkeydown=function(e){return e.keyCode>=33&&e.keyCode<=40?!0:void 0}},$(".bg-modal, .modal-close, .bg-modal-close").on("click",function(){$(".wrapp-modal").fadeOut(200),c=0}),$(".modal-obr, .wrapp-modal .modal .modal-content .modal-text p span").on("click",function(){$(".wrapp-modal").fadeOut(200),$(".wrapp-form").fadeIn(200),c=0,blocScroll()}),$(".scrollbar-light").scrollbar(),$(".success-close").hover(function(){var e=$(this).children("img");e.stop().animate({opacity:"1"},150)},function(){var e=$(this).children("img");e.stop().animate({opacity:".2"},150)}),$(".btnClose, .success-close").on("click",function(){$(".success").fadeOut(200),document.onmousewheel=document.onwheel=function(){return!0},document.addEventListener("MozMousePixelScroll",function(){return!1},!0),document.onkeydown=function(e){return e.keyCode>=33&&e.keyCode<=40?!0:void 0}}),$(".close").hover(function(){var e=$(this).children("img");e.stop().animate({opacity:"1"},150)},function(){var e=$(this).children("img");e.stop().animate({opacity:".2"},150)}),$(".close, .bg").on("click",function(){$(".wrapp-form").fadeOut(200),document.onmousewheel=document.onwheel=function(){return!0},document.addEventListener("MozMousePixelScroll",function(){return!1},!0),document.onkeydown=function(e){return e.keyCode>=33&&e.keyCode<=40?!0:void 0}}),$(".obrHeader:eq(0), .obrHeader:eq(1)").hover(function(){$(this).stop().animate({top:"-5px"},100)},function(){$(this).stop().animate({top:"0px"},100)}),$(".obrHeader").on("click",function(){$(".wrapp-form").fadeIn(200),document.onmousewheel=document.onwheel=function(){return!1},document.addEventListener("MozMousePixelScroll",function(){return!1},!1),document.onkeydown=function(e){return e.keyCode>=33&&e.keyCode<=40?!1:void 0}});var o,t,r,i,c=0;$(".iconSpoiler, .preview").on("click",function(){c=1;var e=$(this).index("."+$(this).attr("class"));null!=o&&(o.css("display","none"),t.css("display","none"),r.css("display","none")),t=$(".heading h3:eq("+e+")"),t.css("display","block"),o=$(".modal-text:eq("+e+")"),o.css("display","block").delay(100),r=$(".modal-footer:eq("+e+")"),r.css("display","block").delay(100),$(".modal-image img").attr("src","images/modal/"+ ++e+".png"),$(".wrapp-modal").fadeIn(200),i=$(window).scrollTop()}),$(window).scroll(function(){c&&$(this).scrollTop(i)}),activeCss=function(e){e.addClass("transform"),e.children("img").addClass("transform-img"),e.children("div").addClass("transform-bg"),e.children("p").addClass("transform-p")},removeCss=function(e){e.removeClass("transform"),e.children("img").removeClass("transform-img"),e.children("div").removeClass("transform-bg"),e.children("p").removeClass("transform-p")};var s=$(".wrapp-reward:first"),a=($(".wrapp-reward:eq(6)"),s),l=0;move=function(){if(7!=a.next().index(".wrapp-reward")){var e=a.next(),n=a.width()/2+e.width()/2;l-=n}else removeCss(a),e=s,l=0;var o=a;a=e,removeCss(o),a.css("z-index","2"),$(".wrapp-galerey").animate({left:l+"px"},550,function(){o.css("z-index","1"),activeCss(a)})};var u=-1115;moveBack=function(){if(1!=a.next().index(".wrapp-reward")){var e=a.prev(),n=a.width()/2+e.width()/2;l+=n}else removeCss(a),e=$(".wrapp-reward:eq(6)"),l=u;var o=a;a=e,removeCss(o),o.css("z-index","1"),a.css("z-index","2"),$(".wrapp-galerey").stop().animate({left:l+"px"},550,function(){activeCss(a)})},a.css("z-index","2"),activeCss(a),startTimer=function(){play=setInterval(function(){move()},8e3)},startTimer(),$(".arrow-right").on("click",function(){clearInterval(play),move(),startTimer()}),$(".arrow-left").on("click",function(){clearInterval(play),moveBack(),startTimer()}),$(".arrow").hover(function(){var e=$(this).children("img"),n=$(this).children("div");e.stop().animate({opacity:"1"},150),n.stop().animate({opacity:"0.6"},150)},function(){var e=$(this).children("img"),n=$(this).children("div");e.stop().animate({opacity:"0.6"},150),n.stop().animate({opacity:"0.3"},150)}),$(".phone").keypress(function(e){var n=$(this).index(".phone"),o="#aeaeae";return"rgb(255, 0, 0)"==$(this).css("border-bottom-color")&&8!=e.which&&0!=e.which&&(e.which<48||e.which>57)?!1:8!=e.which&&0!=e.which&&(e.which<48||e.which>57)?($(".phone:eq("+n+")").stop().css({borderColor:"red"},0).stop().delay(3e3).animate({"border-color":o},500),!1):void 0}),$(".age").keypress(function(e){var n="#aeaeae";return"rgb(255, 0, 0)"==$(this).css("border-bottom-color")&&8!=e.which&&0!=e.which&&(e.which<48||e.which>57)?!1:8!=e.which&&0!=e.which&&(e.which<48||e.which>57)?($(".age").stop().css({borderColor:"red"},0).stop().delay(3e3).animate({"border-color":n},500),!1):void 0}),success=function(e){switch(e){case 0:$(".text-success-header").text("Отзыв успешно отправлен!"),$(".text-success").text("Cпасибо, Ваш отзыв принят."),$(".success").fadeIn(200),document.onmousewheel=document.onwheel=function(){return!1},document.addEventListener("MozMousePixelScroll",function(){return!1},!1),document.onkeydown=function(e){return e.keyCode>=33&&e.keyCode<=40?!1:void 0};break;case 1:$(".text-success-header").text("Заявка успешно отправлена!"),$(".text-success").text("В ближайшее время с Вами свяжутся наши специалисты!"),$(".success").fadeIn(200),document.onmousewheel=document.onwheel=function(){return!1},document.addEventListener("MozMousePixelScroll",function(){return!1},!1),document.onkeydown=function(e){return e.keyCode>=33&&e.keyCode<=40?!1:void 0};break;case 2:$(".text-success-header").text("Ваш вопрос успешно отправлен!"),$(".text-success").text("В ближайшее время с Вами свяжутся наши специалисты!"),$(".success").fadeIn(200),document.onmousewheel=document.onwheel=function(){return!1},document.addEventListener("MozMousePixelScroll",function(){return!1},!1),document.onkeydown=function(e){return e.keyCode>=33&&e.keyCode<=40?!1:void 0};break;case 3:$(".text-success-header").text("Ваш телефон успешно оптравлен!"),$(".text-success").text("В ближайшее время с Вами свяжутся наши специалисты!"),$(".success").fadeIn(200),document.onmousewheel=document.onwheel=function(){return!1},document.addEventListener("MozMousePixelScroll",function(){return!1},!1),document.onkeydown=function(e){return e.keyCode>=33&&e.keyCode<=40?!1:void 0}}},$("input[type='submit']").click(function(e){e.preventDefault()}),$(".replies-send").click(function(){var e=$(".name-replies").val(),n=$(".age").val(),o=$(".reply").val(),t=$(this).val();""==e||""==n||""==o?alert("Заполните все поля"):$.ajax({url:"../mailScript/mailReplies.php",type:"POST",data:{name:e,age:n,reply:o,button:t},success:function(e){e[0]?(success(0),$(".replies").trigger("reset")):alert("Не отправлено")}})}),$(".button").click(function(){var e=$(this).index(".button"),n=$(".name:eq("+e+")").val(),o=$(".phone:eq("+e+")").val(),t=$(".button:eq("+e+")").val(),r=$(".phone:eq("+e+")").val().length,i=e;""==n||""==o?alert("Заполните все поля"):6>r?alert("Не менее 6-ти цифр"):(0===e&&$(".wrapp-form").fadeOut(200),$.ajax({url:"../mailScript/mail.php",type:"POST",data:{name:n,phone:o,button:t,form:i},success:function(n){n[0]?(success(1),$(".form:eq("+e+")").trigger("reset")):alert("Не отправлено")}}))}),$("#btnQuestion").click(function(){var e=$("#mail").val(),n=$("#question").val(),o=$("#btnQuestion").val();form="Задать вопрос, отправив на email",""==e||""==n?alert("Заполните Все поля"):$.ajax({url:"../mailScript/mailq1.php",type:"POST",data:{email:e,question:n,button:o,form:form},success:function(e){e[0]?(success(2),$("#formQuestion").trigger("reset")):alert("Не отправлено")}})}),$("#btnPhone").click(function(){var e=$("#phone5").val(),n=e.length,o=$("#btnPhone").val(),t="Отправить свой номер телефона";""==e?alert("Заполните Все поля"):6>n?alert("Не менее 6-ти цифр"):$.ajax({url:"../mailScript/mailq2.php",type:"POST",data:{phone:e,button:o,form:t},success:function(e){e[0]?(success(3),$("#formPhone").trigger("reset")):alert("Не отправлено")}})}),upBtn=$(".up"),$(window).scroll(function(){$(this).scrollTop()>600?(upBtn.fadeIn(200),0===m&&(m=1,upBtn.children("img").attr("src","images/arrow-up.png"))):1===m&&upBtn.fadeOut(200)});var d,m=1;upBtn.on("click",function(){m?(d=$(window).scrollTop(),$(window).scrollTop(0),upBtn.children("img").attr("src","images/arrow-down.png"),m=0):($(window).scrollTop(d),upBtn.children("img").attr("src","images/arrow-up.png"),m=1)});var p=1;$(".buttonShow").on("click",function(){1==p?($(".wrappQuestions").stop().animate({left:"0px"},200),$(".arrowQuestion").css("background-position","-15px 0px"),p=!p):($(".wrappQuestions").stop().animate({left:"-294px"},200),$(".arrowQuestion").css("background-position","0px 0px"),p=!p)});var h;$(".headerPunctQuestion").on("click",function(){var e=$(this).index(".headerPunctQuestion");null!=h&&(h.css("background",""),h.children("p").css("color","#000")),h=$(this).css("background","#2889FF"),h.children("p").css("color","#fff"),$(".inform:eq("+e+")").stop().slideToggle(100).siblings(".inform:visible").slideUp(100)})});
